    ...
    return(
        <Flex direction='column' w='100%' bgImage={gradient} align='center'>
            ...
            <Flex w='80%' justify='center' gap='5%' my='8vh' align='center' minH='82vh'>
                <Flex direction='column' gap='1em' maxW='30%' >
            ...
            {/* FOOTER */}
            <Flex w='100%' direction='column' align='center' bg='#F0F0F0' py='5em'>
                <Flex w='80%' justify='space-around'>
                    <Flex direction='column' maxW='20%' gap='2em'>
                        <Image boxSize='80%' src={imgLogo}/>
                        <Text fontSize='20px' >Software de gestión para tu taller mecánico</Text>
                    </Flex>
                    <Flex direction='column' maxW='20%' gap='2em'>
                        <Text fontSize='30px' >Empresa</Text>
                        <Text fontSize='20px' >Servicios</Text>
                        <Text fontSize='20px' >precios</Text>
                    </Flex>
                    <Flex direction='column' maxW='20%' gap='2em'>
                        <Text fontSize='30px' >Contacto</Text>
                        <Text fontSize='20px' >anothertool.app@gmail.com</Text>
                        <Text fontSize='20px' >precios</Text>
                    </Flex>
                </Flex>
                <Flex w='80%'  justify='space-around' mt='5em'>
                    <Text fontSize='20px' >anothertool</Text>
                    <Text fontSize='20px' >|</Text>
                    <Text fontSize='20px' >Términos de uso</Text>
                    <Text fontSize='20px' >|</Text>
                    <Text fontSize='20px' >Política de privacidad</Text>
                    <Text fontSize='20px' >|</Text>
                    <Text fontSize='20px' >Seguridad</Text>
                </Flex>
